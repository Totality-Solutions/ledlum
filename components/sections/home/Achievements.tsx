...
import BgImg from "@/public/images/home/home-bg4.png";
import { PopupForm } from "@/components/layout/common/PopupForm";
...
export default function AchievementsSection() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        // Trigger only when user has scrolled significantly into the section
      ...
      { 
        ...
        rootMargin: "0px 0px -100px 0px" // Bottom margin offset to prevent early trigger
      }
    );
  ...
  return (
    <Section className="relative py-12 lg:py-20 bg-cover bg-top bg-no-repeat overflow-hidden will-change-transform">
