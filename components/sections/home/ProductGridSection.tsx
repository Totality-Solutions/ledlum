...
// --- DATA ---
const NEW_ARRIVALS = [
  { id: 1, img: Arrival1, title: 'ledlum-outdoor-thumb', href: "/product/outdoor", downloadUrl: Arrival1.src },
  { id: 2, img: Arrival2, title: 'ledlum-indoor-thumb', href: "/product/indoor", downloadUrl: Arrival2.src },
  { id: 3, img: Arrival3, title: 'artizan-thumb', href: "/product/artizan", downloadUrl: Arrival3.src },
  { id: 4, img: Arrival4, title: 'astara-thumb', href: "/product/astara", downloadUrl: Arrival4.src },
  { id: 5, img: Arrival5, title: 'volaris-thumb', href: "/product/volaris", downloadUrl: Arrival5.src },
  { id: 6, img: Arrival6, title: 'klewe-thumb', href: "/product/klewe", downloadUrl: Arrival6.src },
];
              ...
              <div className="absolute bottom-0 left-0 w-full bg-black p-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="w-8 h-8 md:w-10 md:h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center shrink-0 transition-all duration-300"
