...
//   // --- ADDED: suffix prop to keep IDs unique between Mobile and Desktop ---
...
//             animate={{ 
//               x: `calc(50vw - (${slides[activeIdx].x}px * 1.4))` 
//             }}
//             transition={{ type: "spring", stiffness: 200, damping: 25 }}
//             className="absolute top-0 left-0 h-full"
//             style={{ width: `${REF_W}px` }}
//           >
//             <div className="relative w-full h-full scale-[1.4] origin-left">
