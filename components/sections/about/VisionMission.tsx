...
//       {/* 2. MISSION CIRCULAR IMAGE - Optimized */}
...
//            }}>
//         <Image 
//           src="/images/about/abstractline.png" 
//           alt="abstract wave" 
//           fill 
...
//         <div className="relative w-full mt-32 md:mt-0 flex flex-col md:flex-row justify-between items-center gap-12 md:gap-0 md:h-[180px] pt-10">
...
//         </>
//       )}
//       <div className={`w-[1px] ${lineHeight} bg-gradient-to-b from-white/40 via-white/5 to-transparent`} />
//       {orientation === 'bottom' && (
//         <>
//           <div className="w-1.5 h-1.5 rounded-full bg-white shadow-[0_0_8px_white]" />
  ...
  [@media(min-width:1920px)]:opacity-100 
      ...
      <Container className="relative z-10 !max-w-none px-6 md:px-[10vw]">
        <div className="flex flex-col space-y-32 md:space-y-0 relative min-h-fit md:min-h-[850px]">
          ...
          {/* MISSION */}
          <div className="md:absolute md:top-[40%] md:left-5 flex flex-col items-center md:items-start text-center md:text-left md:mt-[10%] md:ml-[3%]">
            <ArrowCorner className={`${arrowStyle} md:rotate-90 rotate-[135deg]`} />
            <h2 className="font-pop">
              <span className={ourStyle}>Our.</span>
              <span className={wordStyle}>Mission.</span>
