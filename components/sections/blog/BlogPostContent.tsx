...
export const MidSection = ({ title, paragraph, image }: { 
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-32 items-start mb-24">
...
export const BackButton = () => (
  <div className="absolute top-[20px] min-w-[140px] left-1 md:left-12 lg:left-16 z-30 pointer-events-none font-pop">
    ...
    >
      <div className="w-10 h-10 rounded-full bg-black flex items-center justify-center transition-colors group-hover:bg-[#8D794E]">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
          <path d="M19 12H5M12 19l-7-7 7-7" />
        </svg>
      </div>
      <span className="text-body text-white font-pop font-medium pl-2">Back</span>
    </a>
  </div>
);