...
export const ProductInfoSection = ({
  ...
  return (
    <div className="w-full bg-black px-6 md:px-[60px] py-[50px] flex flex-col justify-start items-start gap-12">
      <div className="flex-1 w-full flex flex-col justify-start items-start gap-10">
        
        {/* TOP BAR: Title & Model Code */}
        <div className="w-full flex justify-start items-center gap-2.5">
          <h1 className="text-white text-3xl md:text-[32px] font-semibold font-['Montserrat'] leading-tight">
            {name}
          </h1>
          <span className="text-[#EBEBEB] text-xl font-normal font-['Open Sans']">/</span>
          <span className="text-[#EBEBEB] text-lg font-normal font-['Open Sans'] opacity-80">
            {modelCode}
          </span>
        </div>

        {/* CONTENT WRAPPER: Responsive layout for Text + Button */}
        <div className="w-full flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10">
          ...
          {/* Download Brochure Button: Moves below on mobile, stays right on lg: */}
          <button className="group shrink-0 pl-6 pr-1 py-1.5 bg-[#F3E7D8] rounded-full flex justify-start items-center gap-6 transition-all hover:bg-white">
