    ...
    <AnimatePresence>
      {showScrollTop && (
        <motion.button
          ...
          className="fixed bottom-8 right-8 w-14 h-14 bg-[#8D794E] text-white rounded-full flex items-center justify-center shadow-2xl z-[999] cursor-pointer pointer-events-auto border-2 border-white/30"
