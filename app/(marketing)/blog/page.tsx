  ...
  return (
    <main className="relative min-h-screen bg-black text-white px-6 md:px-16 lg:px-24 py-20 overflow-x-hidden ">
      ...
      <header className="mb-14 relative z-10   ">
        ...
        <p className=" text-white-500 mt-1 desk-h3">That illuminate.</p> */}
        {/* Main Title: Uses your 3.5rem desk size, drops to 2rem on mobile */}
        <h1 className="desk-h1 text-white leading-tight mt-2">
          Insights.
        </h1>

        {/* Subtitle: Uses your 1.125rem body size on mobile, scales to 2rem on desktop */}
        <p className=" mob-h2 desk-h3 text-white/50 mt-2  ">
          That illuminate.
        </p>
        ...
        <div className="mt-8 md:mt-16 bg-[#0a0a0a] border border-white/5 rounded-[32px] md:rounded-[48px] p-6 md:p-8 lg:p-12 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-start transition-all duration-500 overflow-hidden">
          ...
          {/* IMAGE SECTION */}
          <div className="w-full lg:w-[58%] aspect-[4/3] sm:aspect-[16/9] lg:aspect-[16/9] relative rounded-[24px] md:rounded-[32px] overflow-hidden shadow-2xl shrink-0">
            <img
              src={heroPost?.image}
      ...
      {/* --- LATEST INSIGHTS --- */}
      <section className="mb-32 relative z-10 pt-16 pb-0">
      ...
      <section className="pb-20 relative z-10">
        <header className="mb-14">
          <h2 className="desk-h3 text-white ">Stay Updated.</h2>
          <p className=" mob-h2 text-white/50 mt-1 ">With industry insights.</p>
        </header>
