        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-start w-full">
          ...
          <div className="space-y-16">
            <header className="space-y-8">
              <h1 className="desk-h1 leading-[0.9] tracking-tighter">
...
function ContactLink({ label, value, iconType }: { label: string, value: string, iconType: 'mail' | 'phone' | 'whatsapp' }) {
  ...
  return (
    <div className="group flex items-center justify-between p-2 rounded-full border border-white/5 bg-white/[0.03] hover:bg-white/[0.07] transition-all cursor-pointer">
      ...
      <div className="mr-3 w-9 h-9 rounded-full bg-[#8D794E]/20 flex items-center justify-center text-white group-hover:bg-[#8D794E] transition-all duration-300">
